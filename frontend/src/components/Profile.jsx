...
const Profile = () => {
    ...
    useEffect(() => {
        ...
        if(localStorage.getItem('access_token') === null){                   
            ...
            (async () => {
                try {
                    let profile_url = 'https://irit-rtf-ep.ru/api/profile/';
                    if (profileId) {
                        profile_url = `https://irit-rtf-ep.ru/api/profile/${profileId}/`
                    }
    ...
    const sendData = (dataInForm) => {
        axios.put('https://irit-rtf-ep.ru/api/profile/', dataInForm, {
            headers: {
                'Authorization': `Bearer ${localStorage.getItem('access_token')}`
            }
        })
        ...
        <div className="bg-[#71798C] w-screen h-auto p-6">
            <div className="w-[1283px] h-[283px] bg-[#292C33] rounded-3xl p-6">
                ...
                <div className="flex flex-row items-start gap-6">
                    ...
                    : <img src={`https://irit-rtf-ep.ru${userdata.profile_photo}`} width='185' height='185' alt='Кнопка профиля' className="rounded-[50%]"/>
                    }
